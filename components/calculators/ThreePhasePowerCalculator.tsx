...
type CalculateMode = "power" | "current";
...
export default function ThreePhasePowerCalculator() {
  ...
  const [result, setResult] =
    useState<ThreePhasePowerResult | null>(
      null,
    );
  ...
  return (
    <CalculatorShell>
      <CalculatorHeader
        title="Calculadora de potencia trifásica"
        description="Calcula potencia o intensidad en un sistema trifásico considerando la tensión y el factor de potencia."
      />
      ...
      <div className="grid gap-6 p-6 sm:p-8 lg:grid-cols-[1fr_1fr]">
        <div className="space-y-5">
          ...
          <CalculatorInput
            ...
            step="any"
            placeholder="Ej. 400"
            helpText="Tensión del sistema trifásico."
          />
